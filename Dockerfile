...
RUN easy_install https://github.com/trac-hacks/tracsql/archive/master.zip
# RUN pip install git+https://github.com/trac-hacks/tracsql.git
...
RUN easy_install https://trac-hacks.org/svn/jqchartmacro/1.0
...
# dependencia par ao ticketChartsMacro
RUN easy_install https://trac-hacks.org/svn/advparseargsplugin/0.11 
RUN easy_install https://trac-hacks.org/svn/ticketchartsmacro/trunk
# http://trac-hacks.org/wiki/VotePlugin
RUN easy_install https://trac-hacks.org/svn/voteplugin/tags/0.1.5
# TracKanban (not working)
# RUN easy_install https://github.com/wagnerpinheiro/TracKanbanBoard/archive/master.zip
